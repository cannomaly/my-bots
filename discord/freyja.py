...
async def on_message(message):
    ...
    if message.content.startswith('.ai'):
        user_message = message.content[len('.ai '):]  # Extract the user message after ".ai"
        try:
            ...
            response = openai.ChatCompletion.create(
                ...
                max_tokens=150  # Limit the response length and can be changed depending on your api_key access.
            )
